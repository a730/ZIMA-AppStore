...
|------|----------|---------|--------------------|
| 6610 | HTTP | onedev service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| onedev data | `/DATA/AppData/onedev/data` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/onedev
...
Software Bill of Materials for this app's images is available at [../../sboms/onedev/](../../sboms/onedev/).

## Supply Chain

- Base image: `1dev/onedev`
- SBOM: Auto-generated via Trivy (see ../../sboms/onedev/)
