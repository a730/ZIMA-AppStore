...
|------|----------|---------|--------------------|
| 3009 | HTTP | open-webui service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| open-webui data | `/DATA/AppData/open-webui/data` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/open-webui
...
Software Bill of Materials for this app's images is available at [../../sboms/open-webui/](../../sboms/open-webui/).

## Supply Chain

- Base image: `ghcr.io/open-webui/open-webui:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/open-webui/)
