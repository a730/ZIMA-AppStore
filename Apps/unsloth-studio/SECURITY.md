# Security Guide for Unsloth Studio
...
|------|----------|---------|--------------------|
| 8888 | HTTP | unsloth-studio service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| unsloth-studio data | `/DATA/AppData/unsloth-studio/workspace` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/unsloth-studio
...
Software Bill of Materials for this app's images is available at [../../sboms/unsloth-studio/](../../sboms/unsloth-studio/).

## Supply Chain

- Base image: `unsloth/studio`
- SBOM: Auto-generated via Trivy (see ../../sboms/unsloth-studio/)
