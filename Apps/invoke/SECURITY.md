...
|------|----------|---------|--------------------|
| 9090 | HTTP | invokeai service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| invokeai data | `/DATA/AppData/invokeai` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData
...
Software Bill of Materials for this app's images is available at [../../sboms/invoke/](../../sboms/invoke/).

## Supply Chain

- Base image: `ghcr.io/invoke-ai/invokeai:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/invoke/)
