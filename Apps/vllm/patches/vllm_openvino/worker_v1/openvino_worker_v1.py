...
class OpenVINOWorkerV1(WorkerBase):
    ...
    def _init_cached_hf_modules(self) -> None:
        from vllm.utils.import_utils import resolve_obj_by_qualname
        try:
            init_fn = resolve_obj_by_qualname(
                "vllm.transformers_utils.tokenizer:init_cached_hf_modules"
            )
            init_fn()
        except Exception:
            pass
