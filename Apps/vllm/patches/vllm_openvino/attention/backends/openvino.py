...
class OpenVINOAttentionMetadata:
    ...
    # Multi-modal placeholder index maps (unused in OpenVINO backend)
    multi_modal_placeholder_index_maps: Optional[Dict[str, str]]

    # Enable/disable KV scales calculation
