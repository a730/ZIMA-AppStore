...
|------|----------|---------|--------------------|
| 8005 | HTTP | cncjs service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| cncjs data | `/DATA/AppData/CNCjs` | None at rest | Yes |
...
Software Bill of Materials for this app's images is available at [../../sboms/cncjs/](../../sboms/cncjs/).

## Supply Chain

- Base image: `cncjs/cncjs:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/cncjs/)
