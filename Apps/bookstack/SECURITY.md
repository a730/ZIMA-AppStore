...
|------|----------|---------|--------------------|
| 6875 | HTTP | bookstack service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| bookstack data | `/DATA/AppData/bookstack/config` | None at rest | Yes |
| bookstack-db data | `/DATA/AppData/bookstack/db` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/bookstack
...
Software Bill of Materials for this app's images is available at [../../sboms/bookstack/](../../sboms/bookstack/).

## Supply Chain

- Base image: `lscr.io/linuxserver/bookstack:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/bookstack/)
