...
Software Bill of Materials for this app's images is available at [../../sboms/paperless-ngx/](../../sboms/paperless-ngx/).

## Supply Chain

- Base image: `ghcr.io/paperless-ngx/paperless-ngx:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/paperless-ngx/)
