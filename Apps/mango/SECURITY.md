...
|------|----------|---------|--------------------|
| 9000 | HTTP | mango service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| mango data | `/DATA/AppData/Mango/data` | None at rest | Yes |
| mango data | `/DATA/AppData/Mango/config` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/Mango
...
Software Bill of Materials for this app's images is available at [../../sboms/mango/](../../sboms/mango/).

## Supply Chain

- Base image: `ghcr.io/a730/mango:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/mango/)
