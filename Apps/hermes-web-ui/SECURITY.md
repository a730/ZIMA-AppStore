# Security Guide for Hermes Web UI
...
|------|----------|---------|--------------------|
| 6060 | HTTP | hermes-webui service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| hermes-webui data | `/DATA/AppData/hermes-web-ui/hermes_data` | None at rest | Yes |
| hermes-webui data | `/DATA/AppData/hermes-web-ui/webui_data` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/hermes-web-ui
...
1. Set strong values for: - `AUTH_DISABLED`
...
Software Bill of Materials for this app's images is available at [../../sboms/hermes-web-ui/](../../sboms/hermes-web-ui/).

## Supply Chain

- Base image: `ghcr.io/a730/hermes-web-ui:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/hermes-web-ui/)
