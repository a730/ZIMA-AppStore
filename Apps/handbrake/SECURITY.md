...
|------|----------|---------|--------------------|
| 3007 | HTTP | handbrake service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| handbrake data | `/DATA/AppData/handbrake/config` | None at rest | Yes |
| handbrake data | `/DATA/AppData/handbrake/storage` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/handbrake
...
Software Bill of Materials for this app's images is available at [../../sboms/handbrake/](../../sboms/handbrake/).

## Supply Chain

- Base image: `lscr.io/linuxserver/handbrake:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/handbrake/)
