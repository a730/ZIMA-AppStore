...
|------|----------|---------|--------------------|
| 1111 | HTTP | blinko-website service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| postgres data | `/DATA/AppData/blinko/postgres` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/blinko
...
1. Set strong values for: - `NEXTAUTH_SECRET`, - `BLINKO_DB_PASSWORD`
...
Software Bill of Materials for this app's images is available at [../../sboms/blinko/](../../sboms/blinko/).

## Supply Chain

- Base image: `blinkospace/blinko:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/blinko/)
