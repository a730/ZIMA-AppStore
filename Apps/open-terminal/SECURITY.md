# Security Guide for Open Terminal
...
|------|----------|---------|--------------------|
| 4000 | HTTP | open-terminal service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| open-terminal data | `/DATA/AppData/open-terminal/config` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/open-terminal
