# Security Guide for Mission Control
...
|------|----------|---------|--------------------|
| 3000 | HTTP | mission-control service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| mission-control data | `/DATA/AppData/mission-control/data` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/mission-control
...
1. Set strong values for: - `MC_AUTH_PASS`, - `MC_API_KEY`
...
Software Bill of Materials for this app's images is available at [../../sboms/mission-control/](../../sboms/mission-control/).

## Supply Chain

- Base image: `ghcr.io/builderz-labs/mission-control:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/mission-control/)
