...
|------|----------|---------|--------------------|
| 3010 | HTTP | mcphub service | Yes |

## Data Storage

| Data | Location | Encryption | Can user delete? |
|------|----------|------------|------------------|
| mcphub data | `/DATA/AppData/mcphub/data` | None at rest | Yes |
...
tar -czf backup-$(date +%Y%m%d).tar.gz /DATA/AppData/mcphub
...
1. Set strong values for: - `MCPHUB_PASSWORD`
...
Software Bill of Materials for this app's images is available at [../../sboms/mcphub/](../../sboms/mcphub/).

## Supply Chain

- Base image: `samanhappy/mcphub:latest`
- SBOM: Auto-generated via Trivy (see ../../sboms/mcphub/)
